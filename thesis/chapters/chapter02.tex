...
\subsubsection{Rust}
Rust kan source code compileren naar verschillende "targets" (m.a.w verschillende processors). Het
compilatie target voor een browser gebaseerd op WebAssembly heet wasm32-unkown-unkown. Het volgende
