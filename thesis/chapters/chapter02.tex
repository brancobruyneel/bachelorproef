...
\begin{itemize}
  ...
  \item \textbf{Crates}: Een boom van modules die een library of executable produceert
...
Cargo is de Rust package manager. Cargo downloadt de afhankelijkheden van uw Rust pakket, compileert
uw pakketten, maakt distribueerbare pakketten, en upload ze naar crates.io, het pakketregister van
de Rust gemeenschap.
