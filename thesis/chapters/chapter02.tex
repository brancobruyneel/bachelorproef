...
Rust is geschreven als een gecompileerde multi-\gls{paradigma} programmeertaal. Geïnspireerd door de
...
\begin{figure}[h]
  ...
  \caption{JS string naar wasm conversie \cite{wasm_better_for_rust}}
\end{figure}
...
\begin{figure}[h]
  ...
  \caption{publiceren van wasm als npm package \cite{wasm_better_for_rust}}
\end{figure}
