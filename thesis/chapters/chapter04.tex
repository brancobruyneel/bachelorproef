...
\mintinline{rust}{reqwasm} crate te laten vallen, want die is ondertussen toegevoegd aan de
\mintinline{rust}{gloo} crate. Dit zou ook de wasm binary grootte kunnen verkleien.
...
Wat ik ook nog niet heb onderzocht is het optimaliseren van de wasm binary. Volgens de community
